      ...
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title">
            <i class="bi bi-download me-2"></i>Export Assignment Settings
          </h5>
          <button 
            type="button" 
            ...
            <form onsubmit={handleSubmit}>
              ...
              <div class="mb-3">
                <label for="subjectSelection" class="form-label">
                  <i class="bi bi-book me-2"></i>Target Subject
                </label>
              ...
              <div class="mb-3">
                <label for="newAssessmentName" class="form-label">
                  <i class="bi bi-clipboard-check me-2"></i>New Assessment Name
                </label>
                <input 
                  type="text" 
                  class="form-control" 
              ...
              <div class="card bg-light mb-3">
                <div class="card-header">
                  <h6 class="mb-0">
                    <i class="bi bi-copy me-2"></i>Exporting from:
                  </h6>
                </div>
                <div class="card-body">
                  <div class="row">
